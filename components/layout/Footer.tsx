  ...
  return (
    <footer className="relative border-t border-white/10 bg-marketing">
      ...
      <Container>
        ...
        {/* Bottom bar */}
        <div className="flex flex-col items-center justify-between gap-3 border-t border-marketing-alt/10 py-6 text-center text-xs text-marketing-highlight/45 sm:flex-row sm:text-left">
          <p>
            © {year}{" "}
