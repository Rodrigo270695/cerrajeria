        ...
        <Container>
          <div className="max-w-[640px]">
            ...
            >
              ...
              <span className="text-3xl font-bold tabular-nums tracking-tight text-white drop-shadow-md transition-colors group-hover:text-marketing-highlight sm:text-4xl lg:text-[3.1rem]">
                {SITE.phone}
              </span>
            </a>
